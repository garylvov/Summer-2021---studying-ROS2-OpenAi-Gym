...
class ArrayEscapeEnvV1(gym.Env):
    ...
    def __init__(self):
        ...
        self.mine_num = int(self.grid_size * 2) + 1
    ...
    def step(self, action):
        ...
        dist = (((self.items[1][0] - self.items[2][0])**2 + (self.items[1][1] - self.items[2][1])**2)**.5)
            ...
            self.items[1][0] + self.movement[0][action] < 0
            or self.items[1][1] + self.movement[1][action] < 0
            or self.items[1][0] + self.movement[0][action] > self.grid_size -1
            or self.items[1][1] + self.movement[1][action] > self.grid_size -1
